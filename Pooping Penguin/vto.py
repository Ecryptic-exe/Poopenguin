...
async def on_message(message):
    ...
    if any(keyword in current_message for keyword in
           ["兒歌", "老師", "teacher", "sensei", "眠", "nemu", "眠夢", "眼", "眼老", "ねむ", "nemumi", "umi", "oceanic", "ocean",
            ...
            "whats up pop", "toilet", "tiola", "厠所", "who finger", "誰手指", "世界衛生組織手指", "0識", "希望你教","希望教", "我我我"]):
        ...
        try:
            ...
            elif "我我我" in current_message:
                await message.channel.send(COPYPASTA_MEMEME)
                print(f"Bot sent COPYPASTA_MEMEME in channel {message.channel.id}")
